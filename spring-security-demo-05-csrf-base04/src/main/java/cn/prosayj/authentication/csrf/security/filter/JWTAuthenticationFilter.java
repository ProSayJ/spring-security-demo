...
package cn.prosayj.authentication.csrf.security.filter;

import cn.prosayj.authentication.csrf.constant.BaseConstant;
import cn.prosayj.authentication.csrf.model.response.ResponseWriter;
import cn.prosayj.authentication.csrf.model.response.RestBody;
...
import static cn.prosayj.authentication.csrf.util.jwt.JWTUtils.TOKEN_PREFIX;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        response.setHeader(BaseConstant.ACCESS_TOKE, TOKEN_PREFIX + JWTUtils.create(customUserDetails.getName(), false, customUserDetails));
        ResponseWriter
